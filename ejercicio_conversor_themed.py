...
class Aplicacion:
    def __init__(self):
        ...
        self.entryCantidad=ttk.Entry(self.ventana1, width=10, textvariable=self.dato)
        self.entryCantidad.grid(column=1, row=0)

        self.seleccion=tk.IntVar()
        self.seleccion.set(2)
        
        self.radio1=ttk.Radiobutton(self.ventana1,text="Kelvin", variable=self.seleccion, value=1)
        self.radio1.grid(column=0, row=1)
        self.radio2=ttk.Radiobutton(self.ventana1,text="Celsius", variable=self.seleccion, value=2)
        self.radio2.grid(column=1, row=1)
        self.radio3=ttk.Radiobutton(self.ventana1,text="Fahrenheit", variable=self.seleccion, value=3)
        self.radio3.grid(column=2, row=1)

        self.boton1=ttk.Button(self.ventana1, text="Convertir a:", command=self.convertir)
        self.boton1.grid(column=1, row=2)

        self.seleccion1=tk.IntVar()
        self.check1=ttk.Checkbutton(self.ventana1,text="Kelvin", variable=self.seleccion1)
        self.check1.grid(column=0, row=3)

        self.seleccion2=tk.IntVar()
        self.check2=ttk.Checkbutton(self.ventana1,text="Celsius", variable=self.seleccion2)
        self.check2.grid(column=1, row=3)

        self.seleccion3=tk.IntVar()
        self.check3=ttk.Checkbutton(self.ventana1,text="Fahrenheit", variable=self.seleccion3)
        self.check3.grid(column=2, row=3)

        self.labelResKelvin1=ttk.Label(text="Kelvin:")
        self.labelResKelvin1.grid(column=0, row=4)

        self.labelResKelvin2=ttk.Label()
        self.labelResKelvin2.grid(column=1, row=4)

        self.labelResCelsius1=ttk.Label(text="Celsius:")
        self.labelResCelsius1.grid(column=0, row=5)

        self.labelResCelsius2=ttk.Label()
        self.labelResCelsius2.grid(column=1, row=5)

        self.labelResFahrenheit1=ttk.Label(text="Fahrenheit:")
        self.labelResFahrenheit1.grid(column=0, row=6)

        self.labelResFahrenheit2=ttk.Label()
